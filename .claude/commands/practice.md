...
**扫描内容：**
1. **项目技术栈**：检查 package.json、requirements.txt、go.mod 等，识别语言和框架
2. **CLAUDE.md 状态**：是否存在？内容是否完善？是否需要更新？
3. **测试状态**：哪些源文件有对应测试？哪些没有？测试框架是什么？
...
**生成策略：**
- **优先生成项目相关任务**：如"你的 `src/components/UserList.tsx` 没有测试，用 Level 5 方式委托 AI 编写"
...
### 📍 项目扫描发现
[简要列出扫描中发现的与当前聚焦子技能相关的项目状态，如"项目有 12 个组件，其中 5 个没有测试文件"]

### 任务 1：[名称]（项目相关 / 通用练习）
- **难度**：初级/中级/高级
- **预计耗时**：X 分钟/小时
- **项目价值**：[完成后对项目的实际收益，如"补充 5 个组件的测试覆盖"]
- **具体步骤**：
  1. ...
  2. ...
- **验收标准**：[怎样算完成]
