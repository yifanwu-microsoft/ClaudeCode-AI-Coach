...
- **Reference `ai-engineering-leveling-guide.md`** — look up the Practice exercises and Anti-patterns sections for the user's current Level for inspiration and to align with graduation criteria
